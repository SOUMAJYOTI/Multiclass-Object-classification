...
BuildHistograms(imageFileList,imageBaseDir,dataBaseDir,'_sift.mat',params,canSkip);
pyramid_all = CompilePyramid(imageFileList,dataBaseDir,sprintf('_texton_ind_%d.mat',params.dictionarySize),params,canSkip);
